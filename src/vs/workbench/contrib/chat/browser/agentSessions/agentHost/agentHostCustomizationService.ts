...
import { CustomizationType, McpServerCustomization, McpServerStatus, type Customization, type SessionState } from '../../../../../../platform/agentHost/common/state/protocol/state.js';
...
/** An MCP server attached to an agent-host session (inlined from the removed sessions layer). */
