...
// Agents color tokens — side-effect import so they register in the
// global color registry and appear in the color-theme JSON schema.
import './common/agentsTheme.js';

// Agents size tokens (font ramp) — side-effect import so they register
